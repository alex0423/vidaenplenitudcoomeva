...
public class DelegadoWSVinculacionServiceLocator extends org.apache.axis.client.Service implements co.com.coomeva.ws.tipovinculacion.client.DelegadoWSVinculacionService {
    ...
    public co.com.coomeva.ws.tipovinculacion.client.DelegadoWSVinculacion getvincularCliente() throws javax.xml.rpc.ServiceException {
    ...
    public co.com.coomeva.ws.tipovinculacion.client.DelegadoWSVinculacion getvincularCliente(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.com.coomeva.ws.tipovinculacion.client.VincularClienteSoapBindingStub _stub = new co.com.coomeva.ws.tipovinculacion.client.VincularClienteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.com.coomeva.ws.tipovinculacion.client.DelegadoWSVinculacion.class.isAssignableFrom(serviceEndpointInterface)) {
                co.com.coomeva.ws.tipovinculacion.client.VincularClienteSoapBindingStub _stub = new co.com.coomeva.ws.tipovinculacion.client.VincularClienteSoapBindingStub(new java.net.URL(vincularCliente_address), this);
                _stub.setPortName(getvincularClienteWSDDServiceName());
                return _stub;
            }
        }
