			...
			<body>
				...
				<ice:form partialSubmit="true">
					<ice:panelGrid styleClass="icePnlGrdPPAL">
						<ice:panelGrid styleClass="panelCabeceraCreacionActividades">
							<f:facet name="header">
						...
						<ice:panelGrid styleClass="panelButtonCreacionActividades">
							<ice:panelGrid columns="2"
