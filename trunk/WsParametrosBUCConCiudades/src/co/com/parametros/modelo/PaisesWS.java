...
public class PaisesWS  implements java.io.Serializable {
	...
	private co.com.parametros.modelo.Pais[] arrayPaises;
    private long codRetornoWS;
    private java.lang.String descRetornoWS;
    private co.com.parametros.modelo.Pais[] pais;

    public PaisesWS() {
    }

    public co.com.parametros.modelo.Pais[] getArrayPaises() {
        return arrayPaises;
    }

    public void setArrayPaises(co.com.parametros.modelo.Pais[] arrayPaises) {
    ...
    public co.com.parametros.modelo.Pais[] getPais() {
        return pais;
    }

    public void setPais(co.com.parametros.modelo.Pais[] pais) {
        this.pais = pais;
    }
