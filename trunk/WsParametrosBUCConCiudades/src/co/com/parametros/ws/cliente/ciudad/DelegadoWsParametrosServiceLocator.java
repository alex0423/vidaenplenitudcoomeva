...
public class DelegadoWsParametrosServiceLocator extends org.apache.axis.client.Service implements co.com.parametros.ws.cliente.ciudad.DelegadoWsParametrosService {
    ...
    public co.com.parametros.ws.cliente.ciudad.DelegadoWsParametros getconsultarParametros() throws javax.xml.rpc.ServiceException {
    ...
    public co.com.parametros.ws.cliente.ciudad.DelegadoWsParametros getconsultarParametros(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.com.parametros.ws.cliente.ciudad.ConsultarParametrosSoapBindingStub _stub = new co.com.parametros.ws.cliente.ciudad.ConsultarParametrosSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.com.parametros.ws.cliente.ciudad.DelegadoWsParametros.class.isAssignableFrom(serviceEndpointInterface)) {
                co.com.parametros.ws.cliente.ciudad.ConsultarParametrosSoapBindingStub _stub = new co.com.parametros.ws.cliente.ciudad.ConsultarParametrosSoapBindingStub(new java.net.URL(consultarParametros_address), this);
                _stub.setPortName(getconsultarParametrosWSDDServiceName());
                return _stub;
            }
        }
