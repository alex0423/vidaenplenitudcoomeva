...
/**
 * @author Cesar Augusto Ortiz Valencia Clase encargada de manejar la
...
public class InicializacionComponentes extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out
				.println("##########################################################");
		System.out
				.println("         INICIALIZANDO COMPONENTES DE VEP		            ");
		System.out
				.println("##########################################################");
		System.out.println("         [INICIALIZANDO SESSION ....]");

		try {
			SessionLoaders.Util.getInstance().getLOV("estado");
