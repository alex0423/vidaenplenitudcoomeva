...
public class DataRecordAsesor extends AbstractDataRecord implements
	...
	public DataRecordAsesor() {
	}

	public DataRecordAsesor(VepAsociado asociado) {
	...
	public DataRecordAsesor(VepPlusBuc registroBuc) {
