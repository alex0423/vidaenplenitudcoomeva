...
public class DelegadoWSVinculacionServiceLocator extends org.apache.axis.client.Service implements co.com.vida.modelo.DelegadoWSVinculacionService {
    ...
    public co.com.vida.modelo.DelegadoWSVinculacion getvincularCliente() throws javax.xml.rpc.ServiceException {
    ...
    public co.com.vida.modelo.DelegadoWSVinculacion getvincularCliente(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.com.vida.modelo.VincularClienteSoapBindingStub _stub = new co.com.vida.modelo.VincularClienteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.com.vida.modelo.DelegadoWSVinculacion.class.isAssignableFrom(serviceEndpointInterface)) {
                co.com.vida.modelo.VincularClienteSoapBindingStub _stub = new co.com.vida.modelo.VincularClienteSoapBindingStub(new java.net.URL(vincularCliente_address), this);
                _stub.setPortName(getvincularClienteWSDDServiceName());
                return _stub;
            }
        }
