...
public class CiudadesWS  implements java.io.Serializable {
	...
	private co.com.parametros.modelo.Ciudad[] arrayCiudad;
    private co.com.parametros.modelo.Ciudad[] ciudad;
    ...
    public co.com.parametros.modelo.Ciudad[] getArrayCiudad() {
        return arrayCiudad;
    }

    public void setArrayCiudad(co.com.parametros.modelo.Ciudad[] arrayCiudad) {
        this.arrayCiudad = arrayCiudad;
    }

    public co.com.parametros.modelo.Ciudad[] getCiudad() {
        return ciudad;
    }

    public void setCiudad(co.com.parametros.modelo.Ciudad[] ciudad) {
        this.ciudad = ciudad;
    }
