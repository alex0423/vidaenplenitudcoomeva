...
public class ConsultarParametrosSoapBindingStub extends org.apache.axis.client.Stub implements co.com.parametros.modelo.DelegadoWsParametros {
    ...
    static {
        ...
        oper.setReturnClass(co.com.parametros.modelo.ParametrosWS.class);
        ...
        oper.setReturnClass(co.com.parametros.modelo.PaisesWS.class);
        ...
        oper.setReturnClass(co.com.parametros.modelo.CiudadesWS.class);
    ...
    public ConsultarParametrosSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            cls = co.com.parametros.modelo.Pais.class;
            ...
            cachedSerQNames.add(qName);
            cls = co.com.parametros.modelo.PaisesWS.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = co.com.parametros.modelo.CiudadesWS.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = co.com.parametros.modelo.Parametros[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName(LocalApplicationConfigurationWsParametrosBUC.Util.getInstance().getProperty("wsParametrosBUC.consultarParametros.url"), "ArrayOf_tns1_Ciudad");
            cachedSerQNames.add(qName);
            cls = co.com.parametros.modelo.Ciudad[].class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(arraysf);
            cachedDeserFactories.add(arraydf);
            ...
            cachedSerQNames.add(qName);
            cls = co.com.parametros.modelo.ParametrosWS.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public co.com.parametros.modelo.ParametrosWS consultarParametrosXTipo(long tipoParam) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (co.com.parametros.modelo.ParametrosWS) _resp;
            } catch (java.lang.Exception _exception) {
                return (co.com.parametros.modelo.ParametrosWS) org.apache.axis.utils.JavaUtils.convert(_resp, co.com.parametros.modelo.ParametrosWS.class);
            }
        }
    }
    ...
    public co.com.parametros.modelo.PaisesWS consultarTodosPaises() throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (co.com.parametros.modelo.PaisesWS) _resp;
            } catch (java.lang.Exception _exception) {
                return (co.com.parametros.modelo.PaisesWS) org.apache.axis.utils.JavaUtils.convert(_resp, co.com.parametros.modelo.PaisesWS.class);
            }
        }
    }
    ...
    public co.com.parametros.modelo.CiudadesWS consultarCiudadxParametros(java.lang.String codPais, long codDepto) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (co.com.parametros.modelo.CiudadesWS) _resp;
            } catch (java.lang.Exception _exception) {
                return (co.com.parametros.modelo.CiudadesWS) org.apache.axis.utils.JavaUtils.convert(_resp, co.com.parametros.modelo.CiudadesWS.class);
            }
        }
    }
