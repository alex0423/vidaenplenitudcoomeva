...
public class ParametrosWS  implements java.io.Serializable {
    private co.com.parametros.ws.cliente.ciudad.Parametros[] arrayParametros;
    private long codRetornoWS;
    private java.lang.String descRetornoWS;
    private co.com.parametros.ws.cliente.ciudad.Parametros[] parametros;

    public ParametrosWS() {
    }

    public co.com.parametros.ws.cliente.ciudad.Parametros[] getArrayParametros() {
        return arrayParametros;
    }

    public void setArrayParametros(co.com.parametros.ws.cliente.ciudad.Parametros[] arrayParametros) {
    ...
    public co.com.parametros.ws.cliente.ciudad.Parametros[] getParametros() {
        return parametros;
    }

    public void setParametros(co.com.parametros.ws.cliente.ciudad.Parametros[] parametros) {
